...
public class GuildManager {
    ...
    // NEW: Check if location is too close to spawn (0,0)
    public boolean isTooCloseToSpawn(Location loc) {
        // Calculate distance to 0, 0 (ignoring Y axis usually, but 2D distance is standard for maps)
    ...
    public boolean createGuild(String tag, String name, UUID leader, Location center) {
        ...
        // REMOVED: generateBorder(newGuild);
    ...
    // REMOVED: generateBorder, setTopBlock, isVegetation
    ...
    public void loadGuilds() {
        ...
        for (String tag : config.getConfigurationSection("guilds").getKeys(false)) {
            ...
            Gildie guild = new Gildie(tag, name, leaderUUID, wName, x, z, points, created);
