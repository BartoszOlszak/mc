...
public class Gildie {
    ...
    private List<UUID> coLeaders; // NEW: Store Co-Leaders
    ...
    public Gildie(String tag, String name, UUID leader, Location center) {
        ...
        this.coLeaders = new ArrayList<>(); // Init list
    ...
    // Load Existing
    public Gildie(String tag, String name, UUID leader, String worldName, int x, int z, int points, long creationTime) {
        this.tag = tag;
        this.name = name;
        this.leader = leader;
        this.members = new ArrayList<>();
    ...
    public List<UUID> getCoLeaders() { return coLeaders; } // NEW Getter
    ...
    public void removeMember(UUID playerUUID) {
        ...
        coLeaders.remove(playerUUID); // Also remove rank if kicked
    }
